...
/*   var descriptions = new Array(); */
  ...
  function updateData(row_index) {
    ...
    for (var i in areaModel.trash) {
	  ...
	  accordionHTML +=
            'legend{border-bottom:1px solid #ff0000}.accordion-inner{padding:9px 15px;border-top:1px solid #ff0000}.accordion-group{margin-bottom:2px;border:1px solid #ff0000}' +
